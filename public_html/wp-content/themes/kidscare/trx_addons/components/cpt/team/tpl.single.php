			...
			?><div class="team_member_description"><?php
				...
				<div class="team_member_details">
					...
					foreach ($override_options as $k=>$v) {
						if (!empty($v['details']) && !empty($meta[$k])) {
						    if($k == 'ad_title_link' || $k == 'ad_url_link')
                                continue;
				...
				if (!empty($meta['brief_info'])) {
					...
					<div class="team_member_brief_info">
						<h5 class="team_member_brief_info_title"><?php esc_html_e('Brief info', 'kidscare'); ?></h5>
                ...
                $ad_link = '';
                if(isset($meta['ad_title_link']) && isset($meta['ad_url_link']) && !empty($meta['ad_title_link']) && !empty($meta['ad_url_link'])) {
                    kidscare_show_layout('<div class="go-link-wrap"><a class="go-link" href="'.esc_url($meta['ad_url_link']).'">'.esc_html($meta['ad_title_link']).'</a></div>');
                }
