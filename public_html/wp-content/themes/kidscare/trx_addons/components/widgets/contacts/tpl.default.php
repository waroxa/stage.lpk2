	...
	if ($show_info) {
		?><div class="contacts_info"><?php
			if (!empty($address)) {
				...
				?><span class="contacts_address"><b class="label"><?php esc_html_e('Address: ', 'kidscare'); ?></b><?php echo str_replace('|', "<br>", $address); ?></span><?php
				if ($columns) {
					?></div><?php
				}
			}
			if (!empty($phone) || !empty($email)) {
				...
				if (!empty($phone)) {
                    ?><span class="contacts_phone"><b class="label"><?php esc_html_e('Phone: ', 'kidscare'); ?></b><a href="<?php echo esc_attr(trx_addons_get_phone_link($phone)); ?>"><?php echo wp_kses_data($phone); ?></a></span><?php
				}
                if (!empty($email)) {
                    ?><span class="contacts_email"><b class="label"><?php esc_html_e('E-mail: ', 'kidscare'); ?></b><a href="mailto:<?php echo antispambot($email); ?>"><?php echo antispambot($email); ?></a></span><?php
                }
				if ($columns) {
					?></div><?php
				}
