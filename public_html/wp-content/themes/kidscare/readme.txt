...
WordPress version: required at least 5.5, tested up to 6.7.2
...
Please install and activate it before starting to use the theme KidsCare.
...
Theme documentation is available on https://kidscare.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in KidsCare is Fontello.
