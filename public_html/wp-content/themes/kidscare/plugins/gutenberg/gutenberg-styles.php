...
if ( ! function_exists( 'kidscare_gutenberg_add_theme_vars' ) ) {
	add_filter( 'kidscare_filter_add_theme_vars', 'kidscare_gutenberg_add_theme_vars', 10, 2 );
	function kidscare_gutenberg_add_theme_vars( $rez, $vars ) {
		return $rez;
	}
}
...
if ( ! function_exists( 'kidscare_gutenberg_get_css' ) ) {
	add_filter( 'kidscare_filter_get_css', 'kidscare_gutenberg_get_css', 10, 2 );
	function kidscare_gutenberg_get_css( $css, $args ) {
