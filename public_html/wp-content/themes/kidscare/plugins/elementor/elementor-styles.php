...
if ( ! function_exists( 'kidscare_elm_add_theme_vars' ) ) {
	add_filter( 'kidscare_filter_add_theme_vars', 'kidscare_elm_add_theme_vars', 10, 2 );
	function kidscare_elm_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'kidscare_elm_get_css' ) ) {
	add_filter( 'kidscare_filter_get_css', 'kidscare_elm_get_css', 10, 2 );
	function kidscare_elm_get_css( $css, $args ) {
