...
if ( ! function_exists( 'kidscare_trx_addons_add_theme_vars' ) ) {
	add_filter( 'kidscare_filter_add_theme_vars', 'kidscare_trx_addons_add_theme_vars', 10, 2 );
	function kidscare_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'kidscare_trx_addons_get_css' ) ) {
	add_filter( 'kidscare_filter_get_css', 'kidscare_trx_addons_get_css', 10, 2 );
	function kidscare_trx_addons_get_css( $css, $args ) {
...
.sc_action_default .sc_action_item_inner .sc_action_item_link:hover {
	color:{$colors['text_link2']} !important;
}


.sc_action_simple .sc_action_item_simple.with_image .sc_button {
	background-color: {$colors['inverse_link']} !important;
	color: {$colors['text_link']} !important;
}
.sc_action_simple .sc_action_item_simple.with_image .sc_button:hover {
	background-color: {$colors['text_link']} !important;
	color: {$colors['inverse_link']} !important;
}

.sc_action_simple .sc_action_columns_wrap [class*="trx_addons_column-"]:nth-child(2n+2) .sc_action_item_simple.with_image .sc_button {
	background-color: {$colors['inverse_link']} !important;
	color: {$colors['text_link2']} !important;
}
.sc_action_simple .sc_action_columns_wrap [class*="trx_addons_column-"]:nth-child(2n+2) .sc_action_item_simple.with_image .sc_button:hover {
...
.sc_courses_default .sc_courses_columns_wrap .sc_courses_item {
	background-color: {$colors['text_hover']};
}
.sc_courses_default .sc_courses_item_meta a:hover *,
.sc_courses_default .sc_courses_item_meta a:hover,
.sc_courses_default .sc_courses_item_price a:hover,
.sc_courses_default .sc_courses_item_title a:hover {
  color: {$colors['text_link2']} !important;
}

.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(2n+2) .sc_courses_item {
	background-color: {$colors['text_link2']};
}
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(2n+2) .sc_courses_item .sc_courses_item_meta a:hover *,
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(2n+2) .sc_courses_item .sc_courses_item_meta a:hover,
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(2n+2) .sc_courses_item .sc_courses_item_price a:hover,
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(2n+2) .sc_courses_item .sc_courses_item_title a:hover {
  color: {$colors['text_hover']} !important;
}

.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(3n+3) .sc_courses_item {
	background-color: {$colors['text_hover2']};
}
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(3n+3) .sc_courses_item .sc_courses_item_meta a:hover *,
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(3n+3) .sc_courses_item .sc_courses_item_meta a:hover,
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(3n+3) .sc_courses_item .sc_courses_item_price a:hover,
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(3n+3) .sc_courses_item .sc_courses_item_title a:hover {
  color: {$colors['text_hover']} !important;
}

.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(4n+4) .sc_courses_item {
	background-color: {$colors['text_hover3']};
}
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(4n+4) .sc_courses_item .sc_courses_item_meta a:hover *,
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(4n+4) .sc_courses_item .sc_courses_item_meta a:hover,
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(4n+4) .sc_courses_item .sc_courses_item_price a:hover,
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(4n+4) .sc_courses_item .sc_courses_item_title a:hover {
  color: {$colors['text_hover']} !important;
}

.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(5n+5) .sc_courses_item {
	background-color: {$colors['text_link']};
}
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(5n+5) .sc_courses_item .sc_courses_item_meta a:hover *,
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(5n+5) .sc_courses_item .sc_courses_item_meta a:hover,
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(5n+5) .sc_courses_item .sc_courses_item_price a:hover,
.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(5n+5) .sc_courses_item .sc_courses_item_title a:hover {
  color: {$colors['text_link2']} !important;
}

.sc_courses_default .sc_courses_columns_wrap [class*="trx_addons_column-"]:nth-child(6n+6) .sc_courses_item {
...
.sc_services_light .sc_services_item .sc_button:hover {
	color: {$colors['text_link']};
}
...
.sc_services_light .with_icon.sc_services_item:hover .sc_services_item_icon {
	color: {$colors['alter_link3']};
}
.sc_services_light .with_icon .sc_services_item_title a:hover {
	color: {$colors['alter_link3']};
}
.sc_services_light .with_icon .sc_button:hover {
...
/* Skills (Counters) */
.sc_skills_counter .sc_skills_columns .sc_skills_item_wrap {
	background-color: {$colors['text_link']};
}
.sc_skills_counter .sc_skills_columns [class*="trx_addons_column-"]:nth-child(3n+2) .sc_skills_item_wrap {
    background-color: {$colors['text_link2']};
}
.sc_skills_counter .sc_skills_columns [class*="trx_addons_column-"]:nth-child(3n+3) .sc_skills_item_wrap {
   background-color: {$colors['text_hover2']};
}
.sc_skills_counter .sc_skills_columns [class*="trx_addons_column-"]:nth-child(4n+4) .sc_skills_item_wrap {
   background-color: {$colors['text_hover3']};
}
...
.sc_team_default .post_featured .go-link {
	background-color: {$colors['inverse_link']};
	color: #023661;
}

.team_member_description .go-link:hover,
.sc_team_default .go-link:hover {
	background-color: {$colors['text_hover']};
	color: {$colors['inverse_link']};
}
...
.sc_team.sc_team_featured .sc_button:hover {
	color: {$colors['text_link']} !important;
}
...
.sc_team.sc_team_featured .mask {
	background-color: {$colors['text_hover_04']};
}
.sc_team.sc_team_featured .sc_team_item_title a:hover {
	color: {$colors['text_hover']};
}
...
.sc_button.trx_addons_scroll_to_top.style-1:hover  {
	color: {$colors['text_link']} !important;
	background-color: {$colors['inverse_link']} !important;
}
...
.sc_testimonials_default .slider_container.slider_controls_side .slider_controls_wrap > a:hover, 
.sc_testimonials_default .slider_outer_controls_side .slider_controls_wrap > a:hover {
	color: {$colors['text_link']};
}
...
.sc_title.color_style_dark .sc_button_default:hover {
...
.sc_widget_twitter .slider_container.slider_controls_side .slider_controls_wrap > a:hover, 
.sc_widget_twitter .slider_outer_controls_side .slider_controls_wrap > a:hover {
	color: {$colors['text_link']};
}
