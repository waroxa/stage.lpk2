...
if ( ! function_exists( 'kidscare_customizer_get_css' ) ) {

	function kidscare_customizer_get_css( $args = array() ) {
		...
		if ( $fonts ) {
			...
			$fonts = kidscare_customizer_add_theme_fonts( $fonts );
...
CSS;
			$rez          = apply_filters( 'kidscare_filter_get_css', $rez, array( 'fonts' => $fonts ) );
			$css['fonts'] = $rez['fonts'];
		}
		...
		if ( $vars ) {
			...
			// Make theme-specific fonts rules
			$vars = kidscare_customizer_add_theme_vars( $vars );
			extract( $vars );
...
CSS;
			$rez          = apply_filters( 'kidscare_filter_get_css', $rez, array( 'vars' => $vars ) );
			$css['vars']  = $rez['vars'];
		}
		...
		//--------------------------------------
		if ( false !== $colors ) {
			$schemes = empty( $scheme ) ? array_keys( kidscare_get_sorted_schemes() ) : array( $scheme );
			...
			if ( count( $schemes ) > 0 ) {
				...
				foreach ( $schemes as $s ) {
					// Prepare colors
					if ( empty( $scheme ) ) {
						$colors = kidscare_get_scheme_colors( $s );
					}
...
.comment_body table > tbody > tr:nth-child(2n+1) > td {
...
.wpcf7-form.sent input[type="text"]:focus,
.wpcf7-form.sent input[type="text"].filled,
.wpcf7-form.sent input[type="number"]:focus,
.wpcf7-form.sent input[type="number"].filled,
.wpcf7-form.sent input[type="email"]:focus,
.wpcf7-form.sent input[type="email"].filled,
.wpcf7-form.sent input[type="tel"]:focus {
...
#booked-page-form .login-remember label input[type="checkbox"]:before {
	border-color: {$colors['input_bd_color']} !important;
}
.trx_addons_popup_form_wrap input[type="radio"] + label:before,
.trx_addons_popup_form_wrap input[type="checkbox"] + label:before,
.trx_addons_popup_form_wrap .wpcf7-list-item-label.wpcf7-list-item-right:before {
...
/* Normal button */
.wp-block-button:not(.is-style-outline) .wp-block-button__link:not(.has-text-color):not(.has-text-color),
form button:not(.components-button),
input[type="reset"],
input[type="submit"],
input[type="button"],
...
/* Disabled buttons */
button[disabled],
body form.comment-form input[type="submit"][disabled],
body form.wpcf7-form input[type="submit"][disabled],
...
body .booked-list-view button.button[disabled]:hover,
...
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_cart {
	background-color: {$colors['text_hover']};
	color: {$colors['inverse_link']};
}

.sc_layouts_row_type_narrow .sc_layouts_cart:hover .sc_layouts_item_details_line1,
.sc_layouts_row_type_narrow .sc_layouts_cart:hover .sc_layouts_item_details_line2,
.sc_layouts_row_type_narrow .sc_layouts_cart:hover > .sc_layouts_item_icon  {
	color: {$colors['text_hover3']};
}
...
.search_style_fullscreen.search_opened .search_form {
	border-color: {$colors['text_dark_07']};
}
...
.sc_layouts_menu_nav > li > a:not(.trx_addons_login_link):hover,
.sc_layouts_menu_nav > li.sfHover > a:not(.trx_addons_login_link) {
	color: {$colors['inverse_link']} !important;
	background-color: {$colors['text_link']};
}
...
.menu_hover_slide_box .sc_layouts_menu_nav > li.blob_over > a {
	color: {$colors['inverse_link']} !important;
}
...
.sc_layouts_cart_widget .cart_list li a {
	color: {$colors['text_dark']} !important;
}
.sc_layouts_cart_widget .cart_list li a:hover {
	color: {$colors['text_hover3']} !important;
}
...
.kidscare_tabs .kidscare_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_hover']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.kidscare_tabs .kidscare_tabs_titles li.ui-state-active a {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_hover']};
}
...
.sheme_self.sidebar .kidscare_tabs .kidscare_tabs_titles li a {
	color: {$colors['alter_dark']};
	background-color: {$colors['alter_bg_hover']};
}
.sheme_self.sidebar div.esg-filter-wrapper .esg-filterbutton > span:hover,
.sheme_self.sidebar .mptt-navigation-tabs li a:hover,
.sheme_self.sidebar .kidscare_tabs .kidscare_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link']};
}
...
.sheme_self.sidebar .kidscare_tabs .kidscare_tabs_titles li.ui-state-active a {
...
.post_meta_item.post_author:hover .post_author_name {
	color: {$colors['text_dark']};
}
...
.post_content .widget_calendar td#prev a:before,
.post_content .widget_calendar td#next a:before,
.post_content .widget_calendar .wp-calendar-nav a:before,
.post_content .wp-block-calendar td#prev a:before,
.post_content .wp-block-calendar td#next a:before,
.post_content .wp-block-calendar .wp-calendar-nav a:before {
	background-color: {$colors['bg_color']};
}
...
.footer_wrap .scheme_self.elementor-section a,
.footer_wrap .scheme_self.vc_row a {
	color: {$colors['text_link']};
}
.scheme_self.footer_wrap a:hover,
.footer_wrap .scheme_self.elementor-section a:hover,
...
.wp-block-latest-comments__comment .wp-block-latest-comments__comment-author:hover {
	color: {$colors['text_hover']};
}
...
.breadcrumbs span:not(.breadcrumbs_delimiter) {
...
.bg_link2 .search_style_fullscreen button.search_submit {
	background-color: {$colors['text_link2']} !important;
	color: {$colors['inverse_link']} !important;
}
.bg_link2 .search_style_fullscreen button.search_submit:hover {
	background-color: {$colors['text_link']} !important;
}


.bg_link .search_style_fullscreen button.search_submit {
	background-color: {$colors['text_link']} !important;
	color: {$colors['inverse_link']} !important;
}
.bg_link .search_style_fullscreen button.search_submit:hover {
	background-color: {$colors['text_hover']} !important;
}


.search_style_fullscreen button.search_submit {
	background-color: {$colors['text_hover3']} !important;
	color: {$colors['inverse_link']} !important;
}
.search_style_fullscreen button.search_submit:hover {
	background-color: {$colors['text_link']} !important;
}
.search_style_fullscreen button.search_submit:before {
	color: {$colors['inverse_link']} !important;
}
...
.header_button_color_style_2 .sc_button {
	background-color: #fde7db !important;
	color: {$colors['text_link']} !important;
}
.header_button_color_style_1 .sc_button:hover,
.header_button_color_style_2 .sc_button:hover {
	background-color: {$colors['text_link']} !important;
	color: {$colors['inverse_link']} !important;
}
...
.post_layout_excerpt .bottom-info .more-link:hover {
	background-color: {$colors['text_link']};
}
...
.link-shadow {
	-webkit-box-shadow: 6px 5px 0 0 {$colors['text_link']} !important;
	-ms-box-shadow: 6px 5px 0 0 {$colors['text_link']} !important;
	box-shadow: 6px 5px 0 0 {$colors['text_link']} !important;
}
.color_style_dark.link-shadow:hover {
...
.slider_alias_main .hesperiden.tparrows:before,
.slider_alias_main .hesperiden.sr7-arrows:before {
	color: {$colors['text_hover3']} !important;
}
.slider_alias_health .hesperiden.tparrows:before,
.slider_alias_health .hesperiden.sr7-arrows:before {
...
.slider_alias_shop .custom .tp-bullet:hover,
.slider_alias_shop .custom .tp-bullet.selected,
.slider_alias_shop .custom .sr7-bullet:hover,
.slider_alias_shop .custom .sr7-bullet.selected {
	background-color: {$colors['text_hover']} !important;
}
...
.rev_slider .socials_wrap .social_item:hover .social_icon i {
	color: {$colors['inverse_link']} !important;
	background-color: {$colors['text_hover']} !important;
}
...
.wp-block-button.is-style-outline>.wp-block-button__link:not(.has-text-color):hover, .wp-block-button .wp-block-button__link.is-style-outline:not(.has-text-color):hover{
    color: {$colors['text_link']};
}
...
.footer_widgets_inner .wp-block-search input[type="search"]{
...
CSS;
					...
					$rez            = apply_filters(
						'kidscare_filter_get_css', $rez, array(
							'colors' => $colors,
							'scheme' => $s,
						)
					);
		...
		return apply_filters( 'kidscare_filter_prepare_css', $css_str, $remove_spaces );
	}
}
