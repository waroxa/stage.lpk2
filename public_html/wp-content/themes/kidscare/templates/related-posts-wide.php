...
?><div id="post-<?php the_ID(); ?>" <?php post_class( 'related_item post_format_' . esc_attr( $kidscare_post_format ) ); ?>>
	...
	kidscare_show_post_featured(
		array(
			'thumb_size'    => apply_filters( 'kidscare_filter_related_thumb_size', kidscare_get_thumb_size( (int) kidscare_get_theme_option( 'related_posts' ) == 1 ? 'big' : 'med' ) ),
