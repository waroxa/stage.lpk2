	...
	<div class="sb-tab-box sb-deprecate-notice clearfix" v-if="deprecateCustomSnippets()">
		...
		<div class="sb-notice-action">
			<button class='sb-btn sb-btn-secondary' @click.prevent.default="installMigrateSnippets()">
				...
				{{sbi_settings.wpCode.pluginInstalled ? (sbi_settings.wpCode.pluginActive ?
				feedsTab.customSnippetsDeprecation.migrateButton : feedsTab.customSnippetsDeprecation.activateButton) :
				feedsTab.customSnippetsDeprecation.installButton}}
