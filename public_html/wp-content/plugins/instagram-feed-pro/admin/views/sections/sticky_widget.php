<div class="sbi-stck-wdg">
	...
	<div class="sbi-stck-pop" v-if="stickyWidget">
		<div class="sbi-stck-el sbi-stck-el-upgrd sb-btn-orange">
			<div
				class="sbi-stck-el-icon"><?php echo InstagramFeed\Builder\SBI_Feed_Builder::builder_svg_icons($smashballoon_info['upgrade']['icon']); ?></div>
		...
		<div class="sbi-stck-title"><?php esc_html_e('Our Feeds for other platforms', 'instagram-feed') ?></div>
		...
		<div class="sbi-stck-el-list sbi-fb-fs">
			<?php foreach ($smashballoon_info['platforms'] as $platform) : ?>
				<div class="sbi-stck-el sbi-fb-fs">
					...
					<div
						class="sbi-stck-el-txt sb-small-text sb-small-p sb-dark-text"><?php echo $platform['name'] ?></div>
					<div class="sbi-chevron">
	...
	<div class="sbi-stck-wdg-btn" @click.prevent.default="toggleStickyWidget">
		<span
			v-if="!stickyWidget"><?php echo InstagramFeed\Builder\SBI_Feed_Builder::builder_svg_icons('smash'); ?></span>
