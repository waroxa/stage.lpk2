	...
	<div class="sb-customizer-sidebar"
		...
		<div class="sb-customizer-sidebar-sec1 sbi-fb-fs">
			<div class="sb-customizer-sidebar-tab-ctn sbi-fb-fs" v-if="customizerScreens.activeSection == null">
				<div class="sb-customizer-sidebar-tab" v-for="tab in customizerSidebarBuilder"
					 :data-active="customizerScreens.activeTab == tab.id"
					 @click.prevent.default="switchCustomizerTab(tab.id)"><span class="sb-standard-p sb-bold">{{tab.heading}}</span>
				</div>
			</div>
			...
			<div class="sb-customizer-sidebar-sec-ctn sbi-fb-fs" v-if="customizerScreens.activeSection == null">
				<div v-for="(section, sectionId) in customizerSidebarBuilder[customizerScreens.activeTab].sections">
					<div :class="'sb-customizer-sidebar-sec-el cff-fb-fs sb-customizer-sidebar-section-' + sectionId"
						 v-if="!section.isHeader && !section.isInfo"
					...
					<div class="sb-customizer-sidebar-sec-elinfo sbi-fb-fs"
						 v-if="section.isInfo && checkPersonalAccount()">
			...
			<div class="sbi-fb-fs" v-if="customizerScreens.activeSection != null">
				<div class="sb-customizer-sidebar-header sbi-fb-fs"
					...
					<div class="sb-customizer-sidebar-breadcrumb sbi-fb-fs">
						<a @click.prevent.default="switchCustomizerTab(customizerScreens.activeTab)">
							<svg width="6" height="8" viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path
									d="M5.27203 0.94L4.33203 0L0.332031 4L4.33203 8L5.27203 7.06L2.2187 4L5.27203 0.94Z"
									fill="#434960"/>
							</svg>
							{{customizerScreens.activeTab}}
						</a>
						<a v-if="customizerScreens.parentActiveSection != null"
						...
						<a v-if="customizerScreens.parentActiveSection == 'customize_posts' && nestedStylingSection.includes(customizerScreens.activeSection)"
						   @click.prevent.default="backToPostElements()" class="sbi-child-breadcrumb">
							<svg width="6" height="8" viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path
									d="M5.27203 0.94L4.33203 0L0.332031 4L4.33203 8L5.27203 7.06L2.2187 4L5.27203 0.94Z"
									fill="#434960"/>
						...
						<a v-if="viewsActive.moderationMode" @click.prevent.default="saveModerationSettings()"
						   class="sbi-child-breadcrumb">
							<svg width="6" height="8" viewBox="0 0 6 8" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path
									d="M5.27203 0.94L4.33203 0L0.332031 4L4.33203 8L5.27203 7.06L2.2187 4L5.27203 0.94Z"
					...
					<h3>
						...
						<span
							...
							class="sb-breadcrumb-pro-label">PRO</span>
					</h3>
					<span class="sb-customizer-sidebar-intro">
					<span v-html="customizerScreens.activeSectionData.description "></span> <a
				...
				<div class="sb-customizer-sidebar-controls-ctn sbi-fb-fs">
					<div class="sb-customizer-sidebar-sec-el sbi-fb-fs"
