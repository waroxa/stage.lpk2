<div class="sbi-fb-fs"
	 v-if=" ( checkSingleFeedType('user') || checkSingleFeedType('tagged')  || ( !checkBusinessAccount() && checkSingleFeedType('hashtag') ) )"
	 data-source="active">
	<div class="sbi-fb-slctsrc-content sbi-fb-fs">
		...
		<div class="sbi-fb-sources-empty-ctn sbi-fb-fs"
			 v-if="sourcesList.length == 0 || ( !checkBusinessAccount() && checkSingleFeedType('hashtag') )">
				...
				<div class="sbi-fb-srcs-item-inf">
					...
					<div class="sbi-fb-left-boss">
						<div class="sbi-fb-srcs-item-type">
							...
							<span
								class="sb-small sb-lighter">{{source.header_data.account_type || 'Business Advanced'}}</span>
						</div>
