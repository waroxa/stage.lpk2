		...
		<div class="sbi-fb-inst-tbl-ctn sbi-fb-fs">
			<table>
				...
				<tr v-for="(instance, instanceIndex) in viewsActive.instanceSourceActive.instances">
					<td><a :href="sbi_settings.builderUrl+'&feed_id=' + instance.id"
						   class="sbi-fd-lst-name sb-small-p sb-bold">{{instance.feed_name}}</a></td>
					...
					<td>
						<div class="sbi-fb-inst-tbl-shrtc">
							<div class="sb-flex-center">
								<span v-if="instance.id !== 'legacy'" class="sbi-fd-lst-shortcode sb-caption sb-lighter"
									  v-html="'[instagram-feed feed='+instance.id+']'"></span>
								<span v-if="instance.id === 'legacy'" class="sbi-fd-lst-shortcode sb-caption sb-lighter"
									  v-html="'[instagram-feed]'"></span>
								...
								<div class="sbi-fd-lst-shortcode-cp sbi-fd-lst-btn sbi-fb-tltp-parent">
									...
									<div v-html="svgIcons['copy']"
										 @click.prevent.default="copyToClipBoard('[instagram-feed feed='+instance.id+']')"></div>
								</div>
							</div>
						</div>
					</td>
					<td>
						<a :href="sbi_settings.builderUrl+'&feed_id=' + instance.id"
						   class="sbi-fd-lst-btn sb-button-no-border sb-icon-small sb-dark-hover">
