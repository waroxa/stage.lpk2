<div class="sbi-fb-source-ctn sb-fs-boss sbi-fb-center-boss" v-if="viewsActive.tempLoginAboutPopup !== false">
	<div class="sbi-fb-source-popup sbi-fb-tempuser-popup sbi-fb-popup-inside sbi-narrower-modal">
		...
		<div class="sbi-fb-fs">
			<h3><?php esc_html_e('Temporary Login Links', 'instgram-feed') ?></h3>
			...
			<div class="sbi-fb-tempuser-content-list sbi-fb-fs">
				...
				<div class="sbi-fb-tempuser-content-item sbi-fb-fs">
					...
					<div class="sbi-fb-tempuser-item-text">
						<strong
							class="sbi-fb-fs"><?php esc_html_e('What are they used for?', 'instgram-feed') ?></strong>
						<p class="sbi-fb-fs"><?php esc_html_e('Solving an issue in your plugin might sometime require testing API access but with your setup. We do not want to expose your API keys over support messages and hence we use a temporary login link system to securely access it.', 'instgram-feed') ?>
						<p>
					</div>
				</div>
				<div class="sbi-fb-tempuser-content-item sbi-fb-fs">
					...
					<div class="sbi-fb-tempuser-item-text">
						<strong
							class="sbi-fb-fs"><?php esc_html_e('What can a support executive access?', 'instgram-feed') ?></strong>
						<p class="sbi-fb-fs"><?php esc_html_e('A support team member can only access Smash Balloon plugin to make API requests. They can NOT access any other plugins, create posts or in any way modify your WordPress website.', 'instgram-feed') ?>
						<p>
					</div>
				</div>
				<div class="sbi-fb-tempuser-content-item sbi-fb-fs">
					...
					<div class="sbi-fb-tempuser-item-text">
						<strong
							class="sbi-fb-fs"><?php esc_html_e('Can I disable or delete the temporary login link?', 'instgram-feed') ?></strong>
						<p class="sbi-fb-fs"><?php esc_html_e('The login link is auto-destroyed in 14 days. You can also manually delete it any time you want.', 'instgram-feed') ?>
						<p>
					</div>
				</div>
			</div>
			...
			<div class="sbi-fb-tempuser-footer-btn sbi-fb-fs">
				<button class="sb-btn sb-btn-blue" @click.prevent.default="activateView('tempLoginAboutPopup')">
					...
					<strong><?php esc_html_e('Dismiss', 'instgram-feed') ?></strong>
				</button>
			</div>
