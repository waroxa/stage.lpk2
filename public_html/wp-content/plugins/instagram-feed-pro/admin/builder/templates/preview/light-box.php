<script type="text/x-template" id="sbi-dummy-lightbox-component">
	<div id="sbi_lightbox" class="sbi-lightbox-dummy-ctn sbi-lightbox-ctn sbi-dummy-lightbox-ctn sbi_lightbox"
		 :class="[($parent.valueIsEnabled(customizerFeedData.settings.lightboxcomments) ? 'sbi_lb-comments-enabled' : 'sbi_lb-comments-disabled'), (!$parent.valueIsEnabled(customizerFeedData.settings.disablelightbox) ? 'sbi_lightbox-active' : 'sbi_lightbox-disabled')]"
				...
				<div class="sbi_lb-dataContainer" style="width: 1080px;">
						...
						<div class="sbi_lb-details">
							<span class="sbi_lb-caption" style="">
								<a class="sbi_lightbox_username" href="https://www.instagram.com/smashballoon/"
								   target="_blank" rel="noopener">
									<img
										src="<?php echo esc_url(SBI_BUILDER_URL . 'assets/img/landscapeswelove.jpg') ?>">
									<p>@example_user</p>
								</a>
							...
							<div id="sbi_mod_link" class="sbi_lightbox_action">
								<a href="JavaScript:void(0);">
									...
									Hide photo (admin) </a>
								<p id="sbi_mod_box" class="sbi_lightbox_tooltip" style="display: none;">Add ID to the
									<strong>Hide Specific Photos</strong> setting: <span id="sbi_photo_id">sbi_17969273779110928</span>
								</p>
							</div>
						</div>
					...
					<div class="sbi_lb-commentBox sbi_dummy-lb-commentBox"
						...
						<p class="sbi_lb-comment" id="sbi_com_18031479127005270" data-sbi-created="">
							<a class="sbi_lb-commenter" href="https://www.instagram.com/smashballoon/" target="_blank"
							   rel="noopener">johndoe</a>
							<span class="sbi_lb-comment-text">This is an example comment shown in the lightbox</span>
						</p>
						<p class="sbi_lb-comment" id="sbi_com_18031479127005270" data-sbi-created="">
							<a class="sbi_lb-commenter" href="https://www.instagram.com/smashballoon/" target="_blank"
							   rel="noopener">janesmith</a>
