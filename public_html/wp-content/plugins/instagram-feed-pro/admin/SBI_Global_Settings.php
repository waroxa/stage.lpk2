	...
	public function getAdvancedTabData()
	{
		...
		return array(
			...
			'usageBox' => array(
				...
				/* translators: %s is the URL for the "Learn More" link */
				'helpText' => sprintf(__('This helps to prevent plugin and theme conflicts by sending a report in the background once per week about your settings and relevant site stats. It does not send sensitive information like access tokens, email addresses, or user info. This will also not affect your site performance. <a href="%s" target="_blank">Learn More</a>', 'instagram-feed'), $usage_tracking_url),
			),
			'resetErrorBox' => array(
