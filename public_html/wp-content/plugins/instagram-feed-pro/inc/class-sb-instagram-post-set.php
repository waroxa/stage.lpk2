...
class SB_Instagram_Post_Set
{
	...
	/**
	 * The array of resized image data for the set of posts.
	 *
	 * @var array
	 */
	...
	/**
	 * The directory where images are uploaded.
	 *
	 * @var string|null
	 */
	private $upload_dir;
	...
	/**
	 * The URL where images are uploaded.
	 *
	 * @var string|null
	 */
	private $upload_url;
	...
	/**
	 * The timestamp to fill in for the first post in the set.
	 *
	 * @var null
	 */
	...
	/**
	 * The timestamp of the first post in the set.
	 *
	 * @var null
	 */
	...
	/**
	 * The image sizes to create for personal and business account.
	 *
	 * @var array
	 */
	private $image_sizes;
	 ...
	 * @param bool  $transient_name Transient name.
	 * @param null  $fill_in_timestamp (optional) Timestamp to fill in for the first post in the set.
	 ...
	 * @param null  $upload_dir (optional) Directory where images are uploaded.
	 * @param null  $upload_url (optional) URL where images are uploaded.
	 *
	 * @since 2.0/4.0
	 */
	...
	/**
	 * Get the resized image data for the set of posts.
	 *
	 * @return array
	 *
	 * @since 2.0/4.0
