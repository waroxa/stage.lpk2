...
class SB_Instagram_Settings
{
	...
	/**
	 * Array of settings from the wp_options table.
	 *
	 * @var array
	 */
	protected $db;
	...
	/**
	 * Array of settings that will be used in the feed.
	 *
	 * @var array
	 */
	protected $settings;
	...
	/**
	 * Array of connected accounts in the feed.
	 *
	 * @var array
	 */
	...
	/**
	 * Retrieves the settings for a given feed ID.
	 *
	 * @param int        $feed_id The ID of the feed to retrieve settings for.
	 * @param array|bool $preview_settings Optional. If provided and is an array, these settings will be returned instead of fetching from the database. Default false.
	 *
	 * @return array|bool The settings for the specified feed ID, or false if the feed ID is invalid.
	 */
	...
	/**
	 * Returns the default settings for the Instagram Feed Pro plugin.
	 *
	 ...
	 *
	 * @param array $atts Raw attributes to sanitize.
	 *
	 * @return array
	 */
			...
			if (isset($allowed_atts[$key]) && strlen($value) < 500) {
				...
				switch ($sanitization_method) {
					...
					case 'floatval':
						...
						if (
							$allowed_atts[$key]['allowed_vals'] === 'any'
							|| ($value < (float)$allowed_atts[$key]['allowed_vals'])
						) {
							$sanitized_atts[$key] = $value;
						}
	...
	/**
	 * Displays the feed type and terms settings for the Instagram Feed Pro plugin.
	 *
	 * @return array An associative array containing the feed type and terms settings.
	 */
	...
	/**
	 * Retrives the connected accounts for the feed.
	 *
	 * @return array
	 * @since 2.0/5.0
	 */
	...
	/**
	 * Retrieves all the connected accounts in the feed.
	 *
	 * @return array|bool
	 * @since 2.0/5.0
	 */
	...
	/**
	 * Retrieves the transient name for the feed.
	 *
	 * @return bool|string
	 * @since 2.0/5.0
	 */
	 ...
	 * Overwritten in the Pro version.
	 *
	 * @param string $transient_name Optional. The name of the transient to set. Default empty.
	 *
	 * @since 2.0/5.0
	 */
	...
	/**
	 * Retrieves the feed type and terms for the feed.
	 *
	 * @return array|bool
	 *
	 * @since 2.0/5.0
	...
	/**
	 * Adds feed type and terms to the feed.
	 *
	 * @param array $feed_type_and_terms The feed type and terms to add to the feed.
	 *
	 * @since 2.0/5.0
	 */
	 ...
	 *
	 * @param array $connected_accounts The connected accounts to add to the feed.
	 *
	 * @since 2.0/5.0
	 */
