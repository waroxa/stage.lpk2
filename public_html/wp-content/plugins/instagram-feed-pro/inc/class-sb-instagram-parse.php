...
{
	/**
	 * Get the account type based on the data.
	 *
	 ...
	 *
	 * @param array $post Post data.
	 * @param array $resized_images Resized images.
	 *
	 * @return array
	 *
	 * @since 2.0/5.0
	 ...
	 *
	 * @param array  $post Post data.
	 * @param string $default Default caption.
	 *
	 * @return string
	 * @since 2.0/5.0
	 */
	...
	/**
	 * Get the account avatar image.
	 *
	 * @param array $header_data Header data.
	 * @param array $settings Settings.
	 * @param bool  $is_header_attr Is header attribute.
	 *
	 * @return string
	 *
	 * @since 2.0/5.0
	...
	/**
	 * The username of the account used in the header.
	 *
	 * @param array $header_data Header data.
	 *
	 * @return string
	...
	public static function get_bio($header_data, $settings = array())
	{
		...
		return $header_data['data']['bio'] ?? $header_data['bio'] ?? $header_data['biography'] ?? '';
	}
	...
	/**
	 * Get the media type of the post.
	 *
	 * @param array $post Post data.
	 *
	 * @return string
	...
	public static function get_media_video_type($post)
	{
		...
		if ($media_type === 'video') {
			if (strpos($permalink, 'https://www.instagram.com/reel/') !== false || strpos($permalink, 'https://www.instagram.com/tv/') !== false) {
				return 'reels';
			}
			return 'video';
		}
