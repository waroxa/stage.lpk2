...
class SB_Instagram_Cron_Updater
{
	...
	/**
	 * Update a batch of feed caches based on settings.
	 *
	 * @param array $cron_records Array of feed cache records to update.
	 *
	 * @since 6.0
	 */
	 ...
	 * @param bool   $include_resize Whether to resize images during the update since
	...
	public static function start_cron_job($sbi_cache_cron_interval, $sbi_cache_cron_time, $sbi_cache_cron_am_pm)
	{
		...
		} elseif ($sbi_cache_cron_interval === '30mins') {
