...
class SBI_Account_Connector
{
	 ...
	 * sequence
	 *
	 * @param string $sb_instagram_user_id Instagram user id.
	 *
	 * @since 5.10
	 */
	...
	/**
	 * Get the connected accounts from the database.
	 *
	 * @return array
	 *
	 * @since 5.10
	...
	{
		return SBI_Feed_Builder::get_source_list();
	}

	/**
	 * Constructor for the SBI_Account_Connector class.
	 */
	 ...
	 * token and ID
	 *
	 * @param array $data Account data to fetch.
	 *
	 * @return array
	 *
	 * @since 5.10
	 ...
	 * being connected
	 *
	 * @param array $data Account data to add.
	 *
	 * @return bool
	 *
	 * @since 5.10
	...
	public function update_stored_account()
	{
		if (!empty($this->account_data)) {
			InstagramFeed\Builder\SBI_Source::update_single_source($this->get_account_data(), false);
