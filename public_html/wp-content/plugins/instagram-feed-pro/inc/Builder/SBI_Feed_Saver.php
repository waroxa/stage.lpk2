...
class SBI_Feed_Saver
{
	...
	/**
	 * Feed sanitized and sorted data.
	 *
	 * @var array
	 */
	 ...
	 *
	 * @param int $insert_id Database feed id to insert data to.
	 *
	 * @since 6.0
	 */
	 ...
	 * Sets the feed data
	 *
	 * @param array $data Data to set to the data array.
	 *
	 * @since 6.0
	 */
	 ...
	 * Sets the feed name
	 *
	 * @param string $feed_name Feed name to set.
	 *
	 * @since 6.0
	 */
	...
	/**
	 * Retrieve the saved database data.
	 *
	 * @return array
	 *
	 * @since 6.0
	 ...
	 *
	 * @param array $raw_settings Raw settings to format.
	 *
	 * @return array
	 *
	 * @since 6.0
	 ...
	 *
	 * @param bool $return_array If set to true, returns the settings in an array.
	 *
	 * @return array
	 *
	 * @since 6.0
	 ...
	 *
	 * @param array $defaults Default settings to set the feed.
	 *
	 * @return array
	 * @since 6.0
	 */
	...
	/**
	 * Retrieves processed data for a given source.
	 *
	 * @param mixed $source The source data to be processed.
	 * @return mixed The processed source data.
	 */
	 ...
	 *
	 * @param array $settings_db_data Settings db data to build the feed preview.
	 * @return array|bool
	 *
	 * @since 6.0
	 */
