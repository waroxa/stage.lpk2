...
abstract class SB_Controls_Base
{
	 ...
	 * Get Control HTML.
	 *
	 * @param string $editingType Editing type.
	 * @since 6.0
	 * @access public
	 */
	public function print_control_wrapper($editingType)
	{
		...
		<div class="sb-control-elem-ctn sbi-fb-fs" v-if="control.type == '<?php echo $control_type; ?>'"
			 ...
			 :data-reverse="control.reverse != undefined ? 'true' : 'false'"
			 :data-stacked="control.stacked != undefined ? control.stacked : 'false'"
		...
		>
			...
			<div class="sb-control-elem-label"
				 v-if="(control.heading == undefined && control.description == undefined) ? false : true &&  control.type != 'customview'">
				<div class="sb-control-elem-label-title sbi-fb-fs">
					...
					<div class="sb-control-elem-heading sb-small-p sb-dark-text" :data-underline="control.underline"
						...
						<span v-if="control.proLabel != undefined && control.proLabel" class="sb-breadcrumb-pro-label"
							  v-html="control.proLabel != true ? control.proLabel : 'PRO'"></span>
					</div>
					<div class="sb-control-elem-tltp" v-if="control.tooltip != undefined"
						 @mouseover.prevent.default="toggleElementTooltip(control.tooltip, 'show', control.tooltipAlign ? control.tooltipAlign : 'center' )"
			...
			<div class="sb-control-elem-output">
				...
				<div class="sb-control-elem-description"
					 ...
					 v-html="control.description"></div>
			</div>
		</div>
		<?php
	}
