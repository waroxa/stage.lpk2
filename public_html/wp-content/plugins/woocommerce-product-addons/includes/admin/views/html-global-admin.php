...
<div class="wrap woocommerce woocommerce-product-addons">
	<h1><?php esc_html_e( 'Global Add-ons', 'woocommerce-product-addons' ); ?> <a href="<?php echo esc_url( add_query_arg( 'add', true, admin_url( 'edit.php?post_type=product&page=addons' ) ) ); ?>" class="page-title-action"><?php esc_html_e( 'Add new', 'woocommerce-product-addons' ); ?></a></h1><br/>
							<?php

							if ( $global_addons ) {
								?>
		<form id="addons-table" method="GET">
								<?php
									$table->display();
		...
		<div class="woocommerce-BlankState">
			...
			<a class="woocommerce-BlankState-cta button" target="_blank" href="https://woocommerce.com/document/product-add-ons"><?php echo esc_html__( 'Learn more about add-ons', 'woocommerce-product-addons' ); ?></a>
		</div>
								<?php
							}
							?>
