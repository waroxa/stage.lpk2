...
class WC_PAO_Admin_Notices {
	...
	public static function init() {
		...
		if ( ! class_exists( 'WC_PAO_Notices' ) ) {
			require_once __DIR__ . '/../class-wc-product-addons-notices.php';
		}
		...
		self::$maintenance_notices = is_array( get_option( 'wc_pao_maintenance_notices' ) ) ? get_option( 'wc_pao_maintenance_notices' ) : array();
	...
	public static function save_notices() {
		...
		update_option( 'wc_pao_maintenance_notices', self::$maintenance_notices );
	}
