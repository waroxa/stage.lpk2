...
jQuery( document ).ready( function() {
	...
	// Add the description after the link "Check again"
	if ( typeof TRX_UPDATER_STORAGE != 'undefined' && typeof TRX_UPDATER_STORAGE['upgrade_force_check'] != 'undefined' && TRX_UPDATER_STORAGE['upgrade_force_check'] != '' ) {
		jQuery( '.update-last-checked' ).after( '<p class="trx_updater_force_check_description">' + TRX_UPDATER_STORAGE['upgrade_force_check'] + '</p>' );
	}

	// Add the attention message to the theme on the 'update-core' screen
