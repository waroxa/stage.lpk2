	...
	foreach ($components as $comp) {
			...
			if (!is_singular() || have_comments() || comments_open()) {
				...
				$output .= ' ' 
							. '<a href="'.esc_url(get_comments_link()).'" class="post_meta_item post_meta_comments trx_addons_icon-comment">'
								...
								. '<span class="post_meta_label">' . (1==(int)$post_comments ? esc_html__('Comment', 'trx_addons') : esc_html__('Comments', 'trx_addons')) . '</span>'
							. '</a>'
							. ' ';
			}
		...
		// Likes (Emotions)
			...
			$output .= ($emotions_allowed
							...
							. '<span class="post_meta_label">' . (1==(int)$post_likes ? esc_html__('Like', 'trx_addons') : esc_html__('Likes', 'trx_addons')) . '</span>'
						. '</a> ';
