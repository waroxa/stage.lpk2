...
<div class="sc_events_item trx_addons_hover trx_addons_hover_style_links">
		...
		<div class="sc_events_item_header">
			...
			<div class="sc_events_item_meta">
				<span class="sc_events_item_meta_item sc_events_item_meta_date"><?php
					...
					echo sprintf( $dt < date_i18n('Y-m-d')
	...
	<div class="trx_addons_hover_content">
		<h4 class="trx_addons_hover_title"><a href="<?php the_permalink(); ?>" class="trx_addons_hover_title_link"><?php the_title(); ?></a></h4>
		<?php
		...
		if (!empty($args['more_text'])) {
			?><div class="trx_addons_hover_links">
				<a href="<?php the_permalink(); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'trx_addons_hover_link', 'sc_events', $args)); ?>"><?php echo esc_html($args['more_text']); ?></a>
			</div><?php
		}
	?></div>
</div><?php
