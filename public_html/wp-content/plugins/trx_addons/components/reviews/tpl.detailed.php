...
if ( !empty($trx_addons_meta['reviews_enable']) && (int)$trx_addons_meta['reviews_mark'] > 0 ) {
	?><div class="trx_addons_reviews_block trx_addons_reviews_block_detailed"><?php
		...
		// Criterias
		if ( !empty($trx_addons_meta['reviews_criterias']) && count($trx_addons_meta['reviews_criterias']) > 0 && (int)$trx_addons_meta['reviews_criterias'][0]['mark'] > 0 ) {
				...
				<ul class="trx_addons_reviews_block_list">
					...
					foreach($trx_addons_meta['reviews_criterias'] as $item) {
						...
						?><li>
							...
							<?php
							if ( (int)$trx_addons_reviews_max == 5 ) {
