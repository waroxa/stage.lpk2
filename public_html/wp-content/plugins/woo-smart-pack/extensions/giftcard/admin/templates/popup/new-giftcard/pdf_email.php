...
if ( !defined( 'ABSPATH' ) ) {
 ...
 $templ = WooZnd_Util::GetPostTypeOption('wznd_giftcard');
...
<div class="input-box last">
    ...
    <div class="input text-area">
        <textarea name="message" placeholder="<?php echo esc_html__('Message', 'woo-smart-pack'); ?>" style="height: 123px;"></textarea>
    </div>
</div>
