    ...
    <tr>
            ...
            <div class="input-box">
                ...
                <div class="input select-box">
                    <select name="discount_type">                            
                        ...
                        <option value="fixed_product"><?php echo esc_html__('Product Discount', 'woo-smart-pack'); ?></option>
                    </select>
                </div>
            </div>            
            <div class="input-box">
                ...
                <div class="input text-box">
                    <input type="text" disabled="disabled" placeholder="<?php echo esc_html__('Auto Generate', 'woo-smart-pack'); ?>">
                </div>
            </div>          
            <div class="input-box">
                <div class="label">
        ...
        <td class="wide-second">
            ...
            <div class="input-box">
                ...
                <div class="input text-box">
                    <input name="send_date" type="text" class="pop_datepicker" value="<?php ?>" placeholder="<?php echo esc_attr__('Event Date', 'woo-smart-pack'); ?>">
                </div>
            </div>
            ...
            <div class="input-box last">
                ...
                <div class="input text-box">
                    <input name="expiry_date" type="text" class="pop_datepicker" value="" placeholder="<?php echo esc_attr__('Expiry Date', 'woo-smart-pack'); ?>">
                </div>
            </div>
        </td>
    </tr>
