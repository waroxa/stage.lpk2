    ...
    <table class="woo-wide-form">
        <tr>
            <td>
                ...
                <div class="input-box">
                    <div class="label">
                        <span><?php echo esc_html__( 'Beneficiary', 'woo-smart-pack' ); ?></span>
                    </div>
                    <div class="input text-box">
            ...
            <td class="wide-second">
                <div class="input-box">
                    ...
                    <div class="input select-box">
                        <select name="transtype">                
                            <option value="<?php echo esc_attr( WOOZND_WALLET_TRANSANCTION_CREDIT ); ?>"><?php echo esc_html__( 'Credit', 'woo-smart-pack' ); ?></option>
                            <option value="<?php echo esc_attr( WOOZND_WALLET_TRANSANCTION_DEPOSIT ); ?>"><?php echo esc_html__( 'Deposit', 'woo-smart-pack' ); ?></option>                
                            <option value="<?php echo esc_attr( WOOZND_WALLET_TRANSANCTION_REFUND ); ?>"><?php echo esc_html__( 'Refund', 'woo-smart-pack' ); ?></option>
                ...
                <div class="input-box last">
                    ...
                    <div class="input text-area">
                        <textarea name="remark" placeholder="<?php echo esc_html__( 'Remark', 'woo-smart-pack' ); ?>" style="height: 200px;"></textarea>
                    </div>
                </div>
            </td>
        </tr>
