...
<div class="aw-communication-page woocommerce">
	<form action="" class="aw-communication-form" method="post">
			...
			<p>
				...
				echo wp_kses_post(
					sprintf(
						...
						__( 'You are managing preferences for %s.', 'automatewoo' ),
						make_clickable( $customer->get_email() )
					)
				);
				?>
			</p>
		...
		<p>
			...
			<input type="submit" class="woocommerce-Button button aw-communication-form__submit" name="automatewoo_save_changes" value="<?php esc_html_e( 'Save changes', 'automatewoo' ); ?>">
		</p>
	</form>
</div>
