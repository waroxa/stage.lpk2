...
class QuickCal_WC_Meta_Box_Product_Data {
	...
	public function product_type_options( $options ) {
		$options['booked_appointment'] = array(
			...
			'label' => __('QuickCal Product', 'booked'),
			'description' => __('QuickCal Products are hidden from view and only used in booking services.', 'booked'),
			'default' => 'no'
		);
