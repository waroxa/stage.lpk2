...
$parameters = array('action', 'date', 'timeslot', 'app_id', 'app_action');
...
$appt_obj = get_post( $app_id );
$calendar = quickcal_set_appointment_calendar($app_id);
$calendar_id = ( isset($calendar->calendar_obj->term_id) ? (int)$calendar->calendar_obj->term_id : 0 );
