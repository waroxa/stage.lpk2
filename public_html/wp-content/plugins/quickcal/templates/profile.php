	...
	<div class="booked-profile-header bookedClearFix">
		...
		<div class="booked-info">
			<div class="booked-user">
				<div class="booked-user-avatar"><?php echo quickcal_avatar($user_data->ID,50); ?></div>
				<h3 class="<?php echo $h3_class; ?>">
					<?php echo sprintf(esc_html__('Welcome back, %s!','booked'),'<strong>'.quickcal_get_name( $user_data->ID ).'</strong>'); ?>
					<?php if ($my_profile): ?>
