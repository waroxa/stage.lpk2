...
class WC_Deposits_Plans_Admin {
	...
	public function styles_and_scripts() {
		WC_Deposits::register_script( 'woocommerce-deposits-payment-plans', 'payment-plans' );
		wp_localize_script(
		...
		wp_enqueue_style( 'wc-deposits-admin', WC_DEPOSITS_PLUGIN_URL . '/build/admin.css', array( 'wc-admin-layout' ), WC_DEPOSITS_VERSION );
	}
