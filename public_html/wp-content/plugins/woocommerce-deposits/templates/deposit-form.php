...
$deposits_forced       = WC_Deposits_Product_Manager::deposits_forced( $product_id );
$display_style         = $deposits_forced || 'deposit' === $default_selected_type ? 'block' : 'none';
?>
<div class="wc-deposits-wrapper <?php echo $deposits_forced ? 'wc-deposits-forced' : 'wc-deposits-optional'; ?>">
	<?php if ( ! $deposits_forced ) : ?>
