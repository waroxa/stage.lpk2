...
<table class="wc_status_table widefat" cellspacing="0">
	...
	<tbody>
		...
		<tr>
			<td data-export-label="Show My Account"><?php esc_html_e( 'My Account', 'woocommerce-store-credit' ); ?>:</td>
			<td class="help"></td>
			<td><?php echo esc_html( $data['show_my_account'] ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Delete after use"><?php esc_html_e( 'Delete after use', 'woocommerce-store-credit' ); ?>:</td>
			<td class="help"></td>
			<td><?php echo esc_html( $data['delete_after_use'] ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Individual use"><?php esc_html_e( 'Individual use', 'woocommerce-store-credit' ); ?>:</td>
			<td class="help"></td>
			<td><?php echo esc_html( $data['individual_use'] ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Include tax"><?php esc_html_e( 'Include tax', 'woocommerce-store-credit' ); ?>:</td>
			<td class="help"></td>
			<td><?php echo esc_html( $data['inc_tax'] ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Apply to shipping"><?php esc_html_e( 'Apply to shipping', 'woocommerce-store-credit' ); ?>:</td>
			<td class="help"></td>
			<td><?php echo esc_html( $data['apply_to_shipping'] ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Coupon code format"><?php esc_html_e( 'Coupon code format', 'woocommerce-store-credit' ); ?>:</td>
			<td class="help"></td>
