...
<div class="wrap woocommerce">
	...
	<form id="mainform" method="post" action="" enctype="multipart/form-data">
		...
		<p class="submit">
			<button name="save" class="button-primary woocommerce-save-button" type="submit" value="<?php esc_attr_e( 'Send credit', 'woocommerce-store-credit' ); ?>"><?php esc_html_e( 'Send credit', 'woocommerce-store-credit' ); ?></button>
