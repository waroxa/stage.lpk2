...
<div id="message" class="updated woocommerce-message">
	...
	<p>
		...
		printf(
			...
			esc_html__( 'Now you can sell Store Credit coupons to your customers for their own usage or as gift cards.', 'woocommerce-store-credit' )
		);
		?>
	</p>
	<p class="submit">
		...
		printf(
			...
			esc_attr__( 'View Store Credit for WooCommerce documentation', 'woocommerce-store-credit' ),
