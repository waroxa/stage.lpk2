...
class WC_Store_Credit_Cart_Coupons {
	...
	public function __construct() {
		add_action( 'template_redirect', [ $this, 'apply_coupon_from_url' ] );
		add_action( 'woocommerce_add_to_cart', [ $this, 'apply_coupons_from_session' ], 20 );
		add_action( 'woocommerce_before_cart', [ $this, 'available_coupons_content' ], 5 );
		add_action( 'woocommerce_before_checkout_form', [ $this, 'available_coupons_content' ] );
		add_filter( 'woocommerce_add_to_cart_fragments', [ $this, 'refresh_fragments' ] );
		add_filter( 'woocommerce_update_order_review_fragments', [ $this, 'refresh_fragments' ] );
	}
