...
class WC_Store_Credit_REST_API {
	...
	public function __construct() {
		add_filter( 'woocommerce_rest_prepare_shop_order', [ $this, 'order_response' ], 10, 3 ); // V1.
		add_filter( 'woocommerce_rest_prepare_shop_order_object', [ $this, 'order_response' ], 10, 3 );
		add_filter( 'woocommerce_rest_shop_order_schema', [ $this, 'order_schema' ] );
	}
	 ...
	 * @return array
	 */
	protected function process_order_data( $data, $order, $filters = [] ) {
		$credit = wc_get_store_credit_used_for_order( $order );
