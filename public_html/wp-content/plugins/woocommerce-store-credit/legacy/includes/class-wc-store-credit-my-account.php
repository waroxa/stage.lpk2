...
class WC_Store_Credit_My_Account {
	...
	public function __construct() {
		...
		add_filter( 'woocommerce_endpoint_store-credit_title', [ $this, 'store_credit_title' ] );
		add_action( 'woocommerce_account_store-credit_endpoint', [ $this, 'store_credit_content' ] );
