...
namespace Kestrel\Store_Credit\Scoped\CommerceGuys\Addressing\Formatter;

use Kestrel\Store_Credit\Scoped\CommerceGuys\Addressing\AddressInterface;
use Kestrel\Store_Credit\Scoped\CommerceGuys\Addressing\AddressFormat\AddressField;
use Kestrel\Store_Credit\Scoped\CommerceGuys\Addressing\AddressFormat\AddressFormat;
use Kestrel\Store_Credit\Scoped\CommerceGuys\Addressing\AddressFormat\AddressFormatRepositoryInterface;
...
use Kestrel\Store_Credit\Scoped\CommerceGuys\Addressing\Subdivision\SubdivisionRepositoryInterface;
/**
...
class DefaultFormatter implements FormatterInterface
{
     ...
     * @var array
     */
    protected $defaultOptions = ['locale' => 'en', 'html' => \true, 'html_tag' => 'p', 'html_attributes' => ['translate' => 'no']];
    /**
    ...
    protected function buildView(AddressInterface $address, AddressFormat $addressFormat, array $options): array
    {
        ...
        $countryCode = $address->getCountryCode();
        $view = [];
        $view['country'] = ['html' => $options['html'], 'html_tag' => 'span', 'html_attributes' => ['class' => 'country'], 'value' => isset($countries[$countryCode]) ? $countries[$countryCode] : $countryCode];
        foreach ($addressFormat->getUsedFields() as $field) {
            ...
            $view[$field] = ['html' => $options['html'], 'html_tag' => 'span', 'html_attributes' => ['class' => $class], 'value' => $values[$field]];
        }
        return $view;
    }
    /**
