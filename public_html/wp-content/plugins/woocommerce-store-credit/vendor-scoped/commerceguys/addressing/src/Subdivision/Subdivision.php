...
namespace Kestrel\Store_Credit\Scoped\CommerceGuys\Addressing\Subdivision;

use Kestrel\Store_Credit\Scoped\Doctrine\Common\Collections\ArrayCollection;
use Kestrel\Store_Credit\Scoped\Doctrine\Common\Collections\Collection;
/**
...
class Subdivision
{
    ...
    public function __construct(array $definition)
    {
        ...
        $definition += ['parent' => null, 'locale' => null, 'local_code' => null, 'local_name' => null, 'iso_code' => null, 'postal_code_pattern' => null, 'postal_code_pattern_type' => PatternType::getDefault(), 'children' => new ArrayCollection()];
