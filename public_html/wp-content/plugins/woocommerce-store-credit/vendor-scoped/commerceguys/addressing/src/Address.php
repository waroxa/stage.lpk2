...
namespace Kestrel\Store_Credit\Scoped\CommerceGuys\Addressing;
...
class Address implements ImmutableAddressInterface
{
     ...
     */
    public function __construct(?string $countryCode = '', ?string $administrativeArea = '', ?string $locality = '', ?string $dependentLocality = '', ?string $postalCode = '', ?string $sortingCode = '', ?string $addressLine1 = '', ?string $addressLine2 = '', ?string $organization = '', ?string $givenName = '', ?string $additionalName = '', ?string $familyName = '', ?string $locale = 'und')
    {
