...
use Kestrel\Store_Credit\Scoped\CommerceGuys\Addressing\AddressFormat\FieldOverride;
use Kestrel\Store_Credit\Scoped\CommerceGuys\Addressing\AddressFormat\FieldOverrides;
...
class AddressFormatConstraint extends Constraint
{
     ...
     * @var bool
     */
    public $extendedPostalCodeValidation = \true;
    /**
     * @var string
     */
