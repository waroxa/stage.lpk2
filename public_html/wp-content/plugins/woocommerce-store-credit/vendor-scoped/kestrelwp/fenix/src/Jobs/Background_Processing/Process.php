...
namespace Kestrel\Store_Credit\Scoped\Kestrel\Fenix\Jobs\Background_Processing;
...
// phpcs:disable
/**
 * Abstract class for handling background processes in WordPress.
 *
 * This class is directly imported from Delicious Brains' WP Background Processing library.
 * @NOTE The contents of this class should not be modified directly.
 * When a new version of the library is released, this class methods should be replaced with the new version.
 *
 * @version 1.4.0
 * @link https://github.com/deliciousbrains/wp-background-processing/releases/tag/1.4.0
 *
 * @since 1.5.0
 * @internal
 */
abstract class Process extends Async_Request
{
    /**
