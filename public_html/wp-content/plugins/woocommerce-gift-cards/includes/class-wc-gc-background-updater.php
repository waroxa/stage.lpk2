...
if ( ! class_exists( 'WC_GC_Background_Process', false ) ) {
	include_once WC_GC_ABSPATH . 'includes/class-wc-gc-background-process.php';
}
 ...
 * @version  2.0.0
 */
class WC_GC_Background_Updater extends WC_GC_Background_Process {
