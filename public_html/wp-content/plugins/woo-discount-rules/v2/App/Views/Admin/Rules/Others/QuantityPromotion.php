    ...
    <div class="wdr_cart_quantity_promotion_container" style="display: grid;">
        ...
        <div class="wdr_cart_quantity_promo_msg">
            ...
            <textarea
                ...
                style="height: 60px;"
                placeholder="<?php esc_html_e('Buy {{difference_quantity}} more products and get 10% discount', 'woo-discount-rules'); ?>"><?php echo wp_kses_post(($cart_quantity_promotion_message) ? $cart_quantity_promotion_message : ''); ?></textarea>
