	...
	public function getData($grid_id = '') {
		return [
			...
			"postparams" => [
				...
				"media-source-order" => ["vimeo","youtube","html5","featured-image"],
				"poster-source-order" => ["alternate-image","featured-image"],
			...
			"params" => [
				...
				"columns-height" => ["0","0","0","0","0","0","0"],
				"columns-width" => ["1400","1170","1024","960","778","640","480"],
				"mascontent-height" => ["0","0","0","0","0","0","0"],
				"columns" => ["3","3","2","2","2","2","1"],
				...
				"filter-counter" => "off",
				"filter-selected" => ["category_2","category_5","category_4","category_3"],
				...
				"search-text" => "Search...",
				"lb-source-order" => ["featured-image"],
				...
				"lightbox-post-content-img-margin" => ["0","0","0","0"],
