...
class Essential_Grid_Meta
{
	...
	{
		return apply_filters('essgrid_prepare_select_by_string', array_map('trim', explode(',', $string)), $string);
	}
						...
						if (empty($meta_value) && !empty($my_post)) {
							...
							switch ($meta) {
								...
								case 'likespost':
									...
									break;
								case 'date':
									$meta_value = $base->convert_post_date( Essential_Grid_Base::getPostDate($my_post) );
									break;
								case 'date_day':
									$meta_value = Essential_Grid_Base::getPostDate($my_post, 'd');
									break;
								case 'date_month':
									$meta_value = Essential_Grid_Base::getPostDate($my_post, 'm');
									break;
								case 'date_month_abbr':
									$meta_value = Essential_Grid_Base::getPostDate($my_post, 'M');
									break;
								case 'date_year':
									$meta_value = Essential_Grid_Base::getPostDate($my_post, 'Y');
									break;
								case 'date_year_abbr':
									$meta_value = Essential_Grid_Base::getPostDate($my_post, 'y');
									break;
