<?php
/**
 * View: Month Calendar Event Multiday - Single Event Recurring Icon
 *
...
>
	<em class="tribe-events-calendar-month__calendar-event-multiday-recurring-icon">
		<?php $this->template( 'components/icons/recurring', [ 'classes' => [ 'tribe-events-calendar-month__calendar-event-multiday-recurring-icon-svg' ] ] ); ?>
	</em>
