<?php
/**
 * View: Week Mobile Events - Single Event Recurring Icon
 *
...
>
	<em class="tribe-events-pro-week-mobile-events__event-datetime-recurring-icon">
		<?php $this->template( 'components/icons/recurring', [ 'classes' => [ 'tribe-events-pro-week-mobile-events__event-datetime-recurring-icon-svg' ] ] ); ?>
	</em>
