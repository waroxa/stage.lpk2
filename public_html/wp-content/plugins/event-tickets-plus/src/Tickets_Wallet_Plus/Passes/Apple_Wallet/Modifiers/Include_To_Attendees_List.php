...
class Include_To_Attendees_List extends Modifier_Abstract {
	...
	public function get_key(): string {
		return 'apple-wallet/include_to_your_tickets';
	}
	...
	protected function add_actions(): void {
		add_action( 'tribe_template_entry_point:tickets-plus/tickets-wallet-plus/attendees-list/passes:buttons', [ $this, 'add_pass_button' ], 15, 3 );
	}
	...
	protected function remove_actions(): void {
		remove_action( 'tribe_template_entry_point:tickets-plus/tickets-wallet-plus/attendees-list/passes:buttons', [ $this, 'add_pass_button' ], 15 );
	}

	/**
	 * Add Apple Wallet button to the `Attendees List` section.
	 *
	 * @since 6.0.0 Migrated to Event Tickets Plus from Wallet Plus
	 *
